  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <SectionCard>
          <ProfileRowItem icon="person-outline" label="Edit Profile" onPress={() => router.push('/(admin)/edit-profile')} />
          <ProfileRowItem icon="lock-closed-outline" label="Change Password" onPress={() => router.push('/(admin)/change-password')} isLast />
        </SectionCard>

        <SectionTitle title="SETTINGS" />
        <SectionCard>
          <ProfileRowItem icon="notifications-outline" label="Notifications" rightText="on_wireless" onPress={() => router.push('/(admin)/notifications')} isLast />
        </SectionCard>

        <SectionTitle title="SUPPORT" />
        <SectionCard>
          <ProfileRowItem icon="mail-outline" label="Contact Support" onPress={() => router.push('/(admin)/support-inbox')} isLast />
        </SectionCard>
